...
def create_training_env(n_envs: int = 4):
    """Create vectorized training environment"""
    
    def make_env():
        env = create_rl_env(render_mode="rgb_array")
        env = Monitor(env)
        return env
...
def main():
    ...
    config = {
        ...
        'save_freq': 10000,
        'log_interval': 100,
        'model_name': 'so101_sac_active_vision'
    }
    ...
    train_env = create_training_env(n_envs=config['n_envs'])
